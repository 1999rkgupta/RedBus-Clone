...
const RedBus2 = () => {
  return (
   ...
   <div className={styles.desc_group2}>
    ...
    <span class="Platform-hl">Last Minute Booking</span> - In a hurry to book a bus at the last minute? Choose the bus passing from your nearest boarding point and book in a few easy steps. <br /> <span class="Platform-hl">Boarding   Point Navigation</span> -  Never lose your way while travelling to your boarding point! <br/><span class="Platform-hl">Comprehensive Ticket Details </span>- Everything that you need to make the travel hassle free - rest stop details, boarding point images, chat with co-passengers,  wake-up alarm and much more!
   ...
   <img src="http://s2.rdbuz.com/web/images/home/sgp/iPhone_download.png" alt="" />
   </a>
   <a href="https://play.google.com/store/apps/details?id=in.redbus.android&hl=en">
    <img src="http://s3.rdbuz.com/web/images/home/sgp/Google_download.png" alt="" />
   </a>
   </div>
      ...
      <img src="https://s2.rdbuz.com/web/images/home/city_scape_app_download.png" alt="" />
    </section>
  )
}

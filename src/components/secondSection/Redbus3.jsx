        ...
        <div className={styles.content}>
          <div className={styles.subContent}>
            <div className={styles.content1}>
              ...
              <p>
                We take care of your travel beyond ticketing by <br /> providing
                you with innovative and unique <br /> benefits.
              </p>
            </div>
            <div className={styles.content2}>
              ...
              />
              <h3>
                SUPERIOR CUSTOMER <br /> SERVICE
              </h3>
              <p>
                We put our experience and relationships to <br /> good use and
                are available to solve your travel <br /> issues.
              </p>
            </div>
            <div className={styles.content3}>
              ...
              <h3>LOWEST PRICES</h3>
              <p>
                We always give you the lowest price with the <br /> best partner
                offers.always you the lowest price <br /> give you the lowest
                price
              </p>
            </div>
          </div>
